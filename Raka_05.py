...
def b_menu_select():
	...
	time.sleep(0.5)
	print("\x1b[1;94mSILAHKAN DI TUNGGU process is running in background")
	print("")
	print 47 *("-")
	print''
...
def l_menu_select():
	...
	print("Total IDs  : "+str(len(id)))
	time.sleep(0.5)
	print("\x1b[1;93mSILAHKAN DITUNGGU process is running in background")
	print("")
	print 47*("-")
	print('')
	def main(arg):
